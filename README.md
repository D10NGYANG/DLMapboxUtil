...
dependencies {
    // 地图封装
    implementation("com.github.D10NGYANG:DLMapboxUtil:1.1.8")
    // jetpack compose 框架
    implementation("com.github.D10NGYANG:DLJetpackComposeUtil:2.0.22")
    // APP通用工具
    ...
    implementation("com.github.D10NGYANG:DLDatastoreUtil:0.0.8")
}
```
